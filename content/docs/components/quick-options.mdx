...
surface with a lightweight native transition instead of sending shoppers to a
full product page, which makes it a good fit for listing grids, recommendation
modules, and shoppable scenes.
